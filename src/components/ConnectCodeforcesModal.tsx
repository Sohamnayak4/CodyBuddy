...
export default function ConnectCodeforcesModal({
  isOpen,
  onClose,
  onConnected
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || 'Failed to verify Codeforces handle');
      }
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button
                    ...
                    onClick={onClose}
                  >
                    {/* Simple X icon SVG instead of importing from heroicons */}
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500 mb-4">
                      Enter your Codeforces handle to connect your account.
                    </p>
                  ...
                  <div className="mt-4 flex justify-end">
                    <button
                      type="button"
                      className="mr-3 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                      onClick={onClose}
                    >
                      Cancel
                    </button>
